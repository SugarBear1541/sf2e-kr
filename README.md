...
행동명, 기술명, 상태명, 주문명, 자동화 문구와 채팅 출력처럼 실제 플레이에 직접 영향을 주는 부분을 중심으로
...
- 언어 173종을 `한국어명(English Name)` 형식으로 통일
- 언어 선택 창의 중복 표기와 불필요하게 긴 세부 정보 영역 수정
- 주문 431종의 한국어 명칭 전수 검수
- 클래스 기능·피트·NPC 등에 내장된 주문명 1,856건 동기화
- `Humanoid` 태그를 **휴머노이드**로 통일
- 장비 상태의 `Worn` 오역을 **착용**으로 교정
- Foundry 내부 UUID·판정식·피해식·슬러그 보존 검증

전체 변경사항은 [Releases](https://github.com/SugarBear1541/sf2e-kr/releases)에서 확인할 수 있습니다.

- [1.0.6 변경사항](CHANGELOG_106.md)
- [1.0.6 표준 용어집](TERMINOLOGY_106.md)
- [1.0.6 주문명 목록](SPELL_NAMES_106.md)
...
- **Starfinder Second Edition 시스템 1.4.0 이상**
- **Babele 모듈 2.7.9 이상**
